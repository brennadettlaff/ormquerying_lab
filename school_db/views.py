...
def problem_one(request):
    ...
    for student in high_gpa:
        print(f'Student Name: {student.first_name} {student.last_name} GPA: {student.gpa}')
...
def problem_two(request):
    ...
    for name in instructors:
      print(f"Instructor's name:{name.first_name} {name.last_name}  Hire Date:{name.hire_date}")
...
def problem_three(request):
    ...
    print(f"Instructors Name: {instructor.first_name} {instructor.last_name}")
    print("Courses:")
...
def problem_four(request):
    ...
    print(f"Number of Courses: {instructors_count}")
...
def problem_five(request):
    new_student = Student.objects.create(pk = 11, first_name = "Brenna", last_name = "Dettlaff", year = 2022, gpa = 3.5)
...
def problem_six(request):
    Student.objects.filter(pk = 11).update(gpa = 3.7)
